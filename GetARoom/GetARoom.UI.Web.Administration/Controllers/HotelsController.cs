...
namespace GetARoom.UI.Web.Administration.Controllers
{
    public class HotelsController : Controller
    {
        ...
        {
            var hotel = db.Hotel.Include(h => h.Location);
        ...
        public ActionResult Create([Bind(Include = "HotelId,HotelName,LocationId,Phonenumber,HotelDescription,HotelRating")] Hotel hotel)
        {
