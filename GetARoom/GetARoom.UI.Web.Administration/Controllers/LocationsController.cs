...
namespace GetARoom.UI.Web.Administration.Controllers
{
    public class LocationsController : Controller
    {
        ...
        {
            var location = db.Location.Include(l => l.Address).Include(l => l.Geolocation);
        ...
        {
            ViewBag.AddressId = new SelectList(db.Address, "AddressId", "AddressStreetname");
            ViewBag.GeolocationId = new SelectList(db.Geolocation, "GeolocationId", "GeolocationId");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "LocationId,AddressId,GeolocationId")] Location location)
        {
