...
namespace GetARoom.UI.Web.Administration.Controllers
{
    public class AddressesController : Controller
    {
        ...
        {
            var address = db.Address.Include(a => a.Postal);
        ...
        {
            ViewBag.PostalId = new SelectList(db.Postal, "PostalId", "PostalCode");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "AddressId,PostalId,AddressStreetname,AddressNumber,AddressBus,AddressLand")] Address address)
        {
